...
public class CP extends Node {
    ...
    static final int DEFAULT_CLI_PORT = 50002;
    static final int DEFAULT_DST_PORT = 50005;
    static final String DEFAULT_NODE = "cp";
    static final String DEFAULT_CLI_NODE = "dserver";
        ...
        try {
            ...
            switch (content.getPacketType()) {
                ...
                case PacketContent.ACK:
                    ...
                    if(!ackmsg.equals("ACK: OK - Received consultation")) {
                        sender.ackReceipt();
                    }
                    break;
